...
def test_build_command(
    ...
    mock_transmutation_subprocess_exec.return_value = mock_proc
...
def test_build_command_compiler_not_found(
    mock_transmutation_subprocess_exec: Any, mock_open: Any, mock_exists: Any
) -> None:
...
@patch("coreason_ecosystem.orchestration.isomorphism_probe.read_registry_lock")
@patch(
    "coreason_ecosystem.orchestration.isomorphism_probe.httpx.AsyncClient",
    return_value=MockAsyncClient(),
)
@patch("coreason_ecosystem.orchestration.isomorphism_probe.Path.exists")
@patch("coreason_ecosystem.orchestration.isomorphism_probe.Path.read_bytes")
