...
def test_up_command(mock_is_port_bound: Any, mock_exec: Any, mock_exists: Any, mock_write_lock: Any, mock_calc_root: Any) -> None:
...
@patch("coreason_ecosystem.orchestration.up.asyncio.create_subprocess_exec")
@patch("coreason_ecosystem.orchestration.up.is_port_bound")
def test_up_command_all_bound(mock_is_port_bound: Any, mock_exec: Any, mock_write_lock: Any, mock_calc_root: Any) -> None:
...
class MockAsyncClient:
    ...
    async def get(self, _url: str, timeout: float | None = None, headers: Any = None) -> MockResponse:
...
def test_doctor_command(mock_read_bytes: Any, mock_exists: Any, mock_client: Any, mock_read_registry_lock: Any) -> None:
...
@patch("coreason_ecosystem.orchestration.doctor.Path.exists")
@patch("coreason_ecosystem.orchestration.doctor.Path.read_bytes")
def test_doctor_command_error_codes(mock_read_bytes: Any, mock_exists: Any, mock_client: Any, mock_read_registry_lock: Any) -> None:
...
@patch("coreason_ecosystem.orchestration.doctor.Path.exists")
def test_doctor_command_failures(mock_exists: Any, mock_client: Any, mock_read_registry_lock: Any) -> None:
...
class MockAsyncClientHTTP:
    async def __aenter__(self) -> "MockAsyncClientHTTP": return self
    async def __aexit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> None: pass
    async def get(self, _url: str, timeout: float | None = None, headers: Any = None) -> MockResponse: return MockResponse(404)
    def stream(self, _method: str, _url: str, timeout: float | None = None) -> MockStreamResponse: return MockStreamResponse(404)

@patch("coreason_ecosystem.orchestration.doctor.read_registry_lock")
@patch("coreason_ecosystem.orchestration.doctor.httpx.AsyncClient", return_value=MockAsyncClientHTTP())
@patch("coreason_ecosystem.orchestration.doctor.Path.exists")
@patch("coreason_ecosystem.orchestration.doctor.Path.read_bytes")
def test_doctor_command_http_error(mock_read_bytes: Any, mock_exists: Any, mock_client: Any, mock_read_registry_lock: Any) -> None:
    _ = mock_client
    mock_exists.return_value = True
    mock_read_bytes.return_value = b"{}"
    mock_read_registry_lock.return_value = "deadbeef"
...
class MockAsyncClientHTTP409:
    async def __aenter__(self) -> "MockAsyncClientHTTP409": return self
    async def __aexit__(self, exc_type: Any, exc_val: Any, exc_tb: Any) -> None: pass
    async def get(self, _url: str, timeout: float | None = None, headers: Any = None) -> MockResponse: return MockResponse(409)
    def stream(self, _method: str, _url: str, timeout: float | None = None) -> MockStreamResponse: return MockStreamResponse(409)

@patch("coreason_ecosystem.orchestration.doctor.read_registry_lock")
@patch("coreason_ecosystem.orchestration.doctor.httpx.AsyncClient", return_value=MockAsyncClientHTTP409())
@patch("coreason_ecosystem.orchestration.doctor.Path.exists")
@patch("coreason_ecosystem.orchestration.doctor.Path.read_bytes")
def test_doctor_command_http_error_409(mock_read_bytes: Any, mock_exists: Any, mock_client: Any, mock_read_registry_lock: Any) -> None:
    _ = mock_client
    mock_exists.return_value = True
    mock_read_bytes.return_value = b"{}"
    mock_read_registry_lock.return_value = "deadbeef"
